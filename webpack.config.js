/**
 * secp256-key-pair webpack build rules.
 *
...
// "secp256-key-pairs" library but with
// different content
const outputs = [
  // core secp256-key-pairs library
  {
    entry: [
